...
SimpleForm.setup do |config|
  ...
  config.wrappers :materialize_form, tag: 'div', class: 'input-field col s12', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
  ...
  config.wrappers :materialize_text, tag: 'div', class: 'input-field col s12', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
  ...
  config.wrappers :materialize_file_input, tag: 'div', class: 'file-field input-field col', error_class: 'has-error' do |b|
    ...
    b.wrapper tag: :div, class: 'file-path-wrapper' do |ba|
      ba.use :input, class: 'file-path validate', type: 'text', placeholder: 'Browse...'
    end
